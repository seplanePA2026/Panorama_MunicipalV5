...
var style_Sexo_feminino_20_a_24_anos_31 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_feminino_20_a_24_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_feminino_20_a_24_anos") !== null) {
        labelText = String(feature.get("Sexo_feminino_20_a_24_anos"));
    }
    if (value >= 0.000000 && value <= 8.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32.000000 && value <= 64.000000) {
            style = [ new ol.style.Style({
