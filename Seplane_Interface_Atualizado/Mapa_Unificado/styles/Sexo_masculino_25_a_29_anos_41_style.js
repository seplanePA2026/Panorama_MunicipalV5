...
var style_Sexo_masculino_25_a_29_anos_41 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_masculino_25_a_29_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino_25_a_29_anos") !== null) {
        labelText = String(feature.get("Sexo_masculino_25_a_29_anos"));
    }
    if (value >= 0.000000 && value <= 6.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.000000 && value <= 22.714286) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.714286 && value <= 27.857143) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 27.857143 && value <= 51.000000) {
            style = [ new ol.style.Style({
