...
var style_Sexo_feminino_25_a_29_anos_30 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_feminino_25_a_29_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_feminino_25_a_29_anos") !== null) {
        labelText = String(feature.get("Sexo_feminino_25_a_29_anos"));
    }
    if (value >= 0.000000 && value <= 6.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.000000 && value <= 18.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.000000 && value <= 26.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 33.000000 && value <= 58.000000) {
            style = [ new ol.style.Style({
