...
var style_Sexo_feminino_5_a_9_anos_34 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_feminino_5_a_9_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino_5_a_9_anos") !== null) {
        labelText = String(feature.get("Sexo_masculino_5_a_9_anos"));
    }
    if (value >= 0.000000 && value <= 6.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13.000000 && value <= 17.571429) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.571429 && value <= 22.714286) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.714286 && value <= 32.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32.000000 && value <= 67.000000) {
            style = [ new ol.style.Style({
