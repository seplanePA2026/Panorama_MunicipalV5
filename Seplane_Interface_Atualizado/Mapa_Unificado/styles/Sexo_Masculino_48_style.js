...
var style_Sexo_Masculino_48 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_masculino");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino") !== null) {
        labelText = String(feature.get("Sexo_masculino"));
    }
    if (value >= 0.000000 && value <= 112.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 112.000000 && value <= 172.285714) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 172.285714 && value <= 221.428571) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 221.428571 && value <= 266.571429) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 266.571429 && value <= 301.142857) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 301.142857 && value <= 368.428571) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 368.428571 && value <= 630.000000) {
            style = [ new ol.style.Style({
