...
var style_Percentual_domicilios_parti_61 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_Percentual_domicilios_parti_61_eval_expression(context) !== null) {
        labelText = String(exp_label_Percentual_domicilios_parti_61_eval_expression(context));
    }
