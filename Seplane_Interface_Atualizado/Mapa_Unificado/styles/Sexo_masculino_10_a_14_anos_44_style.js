...
var style_Sexo_masculino_10_a_14_anos_44 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_masculino_10_a_14_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino_10_a_14_anos") !== null) {
        labelText = String(feature.get("Sexo_masculino_10_a_14_anos"));
    }
    if (value >= 0.000000 && value <= 7.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.000000 && value <= 20.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20.000000 && value <= 26.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26.000000 && value <= 33.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 33.000000 && value <= 72.000000) {
            style = [ new ol.style.Style({
