...
var style_Sexo_feminino_0_a_4_anos_35 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_feminino_0_a_4_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_feminino_0_a_4_anos") !== null) {
        labelText = String(feature.get("Sexo_feminino_0_a_4_anos"));
    }
    if (value >= 0.000000 && value <= 5.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.000000 && value <= 22.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.000000 && value <= 67.000000) {
            style = [ new ol.style.Style({
