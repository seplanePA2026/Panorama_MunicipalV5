...
var style_Sexo_masculino_5_a_9_anos_45 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_masculino_5_a_9_anos");
    ...
    if (value >= 0.000000 && value <= 7.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.000000 && value <= 32.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32.000000 && value <= 66.000000) {
            style = [ new ol.style.Style({
