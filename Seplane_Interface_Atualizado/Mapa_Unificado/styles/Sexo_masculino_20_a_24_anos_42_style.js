...
var style_Sexo_masculino_20_a_24_anos_42 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_masculino_20_a_24_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino_20_a_24_anos") !== null) {
        labelText = String(feature.get("Sexo_masculino_20_a_24_anos"));
    }
    if (value >= 0.000000 && value <= 7.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.000000 && value <= 21.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26.000000 && value <= 33.714286) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 33.714286 && value <= 60.000000) {
            style = [ new ol.style.Style({
