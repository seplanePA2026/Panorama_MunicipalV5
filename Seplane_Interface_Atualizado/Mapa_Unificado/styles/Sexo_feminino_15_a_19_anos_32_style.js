...
var style_Sexo_feminino_15_a_19_anos_32 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_feminino_15_a_19_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_feminino_15_a_19_anos") !== null) {
        labelText = String(feature.get("Sexo_feminino_15_a_19_anos"));
    }
    if (value >= 0.000000 && value <= 6.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.000000 && value <= 16.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.000000 && value <= 30.000000) {
            style = [ new ol.style.Style({
