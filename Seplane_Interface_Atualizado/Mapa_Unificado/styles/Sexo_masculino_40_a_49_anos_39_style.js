...
var style_Sexo_masculino_40_a_49_anos_39 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_masculino_40_a_49_anos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino_40_a_49_anos") !== null) {
        labelText = String(feature.get("Sexo_masculino_40_a_49_anos"));
    }
    if (value >= 0.000000 && value <= 17.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.000000 && value <= 24.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 24.000000 && value <= 32.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 32.000000 && value <= 38.571429) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 38.571429 && value <= 45.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 45.000000 && value <= 53.714286) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 53.714286 && value <= 118.000000) {
            style = [ new ol.style.Style({
