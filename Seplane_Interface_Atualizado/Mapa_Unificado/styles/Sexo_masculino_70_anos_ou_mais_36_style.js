...
var style_Sexo_masculino_70_anos_ou_mais_36 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Sexo_feminino_70_anos_ou_mais");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Sexo_masculino_70_anos_ou_mais") !== null) {
        labelText = String(feature.get("Sexo_masculino_70_anos_ou_mais"));
    }
    if (value >= 0.000000 && value <= 5.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.000000 && value <= 21.571429) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.571429 && value <= 28.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 28.000000 && value <= 34.000000) {
            style = [ new ol.style.Style({
